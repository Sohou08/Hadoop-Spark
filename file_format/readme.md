...
There are other formats at our disposal more suitable in serialization, exchange data as well in other cases e.g. avro and Protocol Buffers.
...
It can’t be load data directly into ORCFILE, increases CPU overhead by increasing the time it takes to decompress the relational data.
